...
from pywallet import constants, blockchain
from pywallet.simple_config import SimpleConfig
from pywallet.blockchain import Blockchain, deserialize_header, hash_header, InvalidHeader
from pywallet.util import bfh, make_dir

from . import PywalletTestCase


class TestBlockchain(PywalletTestCase):
    ...
    def setUp(self):
        super().setUp()
        self.data_dir = self.pywallet_path
        make_dir(os.path.join(self.data_dir, 'forks'))
        self.config = SimpleConfig({'pywallet_path': self.data_dir})
...
class TestVerifyHeader(PywalletTestCase):
