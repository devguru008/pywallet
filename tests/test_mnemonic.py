...
from pywallet import mnemonic
from pywallet import slip39
from pywallet import old_mnemonic
from pywallet.util import bfh
from pywallet.mnemonic import is_new_seed, is_old_seed, calc_seed_type, is_matching_seed, can_seed_have_passphrase
from pywallet.version import SEED_PREFIX_SW, SEED_PREFIX
...
class Test_NewMnemonic(PywalletTestCase):

    def test_mnemonic_to_seed_basic(self):
        # note: not a valid pywallet seed
...
class Test_OldMnemonic(PywalletTestCase):
...
class Test_BIP39(PywalletTestCase):
...
class Test_seeds(PywalletTestCase):
...
class Test_slip39(PywalletTestCase):
