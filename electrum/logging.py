...
#       as possible.
# Note: some users might use Electrum as a python library and not use run_pywallet,
...
def configure_logging(config: 'SimpleConfig', *, log_to_file: Optional[bool] = None) -> None:
    ...
    _logger.info(f"Electrum version: {PYWALLET_VERSION} - https://electrum.org - {GIT_REPO_URL}")
