...
LNWALLET_FEATURES = (
    ...
    | LnFeatures.OPTION_TRAMPOLINE_ROUTING_OPT_PYWALLET
...
class LNWallet(LNWorker):
    ...
    def _scid_alias_of_node(self, nodeid: bytes) -> bytes:
        ...
        return sha256(b'Pywallet' + nodeid)[0:8]
    ...
    def is_trampoline_peer(self, node_id: bytes) -> bool:
        ...
        return (peer.their_features.supports(LnFeatures.OPTION_TRAMPOLINE_ROUTING_OPT_ECLAIR)\
                or peer.their_features.supports(LnFeatures.OPTION_TRAMPOLINE_ROUTING_OPT_PYWALLET))
    ...
    def get_bolt11_invoice(
        ...
        if not self.uses_trampoline():
            invoice_features &= ~ LnFeatures.OPTION_TRAMPOLINE_ROUTING_OPT_PYWALLET
