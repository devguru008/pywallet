...
from pywallet.submarine_swaps import MIN_FINAL_CLTV_DELTA_FOR_CLIENT
...
"""Lightning support in Pywallet is experimental. Do not put large amounts in lightning channels."""
)

MSG_LIGHTNING_SCB_WARNING = _(
"""Pywallet uses static channel backups. If you lose your wallet file, you will need to request your channel to be force-closed by the remote peer in order to recover your funds. This assumes that the remote peer is reachable, and has not lost its own data."""
)
