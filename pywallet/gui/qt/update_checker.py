...
class UpdateCheck(QDialog, Logger):
    ...
    def __init__(self, *, latest_version=None):
        ...
        self.setWindowTitle('Pywallet - ' + _('Update Check'))
        ...
        versions.addWidget(QLabel(_("Current version: {}").format(version.PYWALLET_VERSION)))
    ...
    def is_newer(latest_version):
        return latest_version > StrictVersion(version.PYWALLET_VERSION)
    ...
    def update_view(self, latest_version=None):
        if latest_version:
            ...
            if self.is_newer(latest_version):
                ...
                self.detail_label.setText(_("You are already on the latest version of Pywallet."))
        else:
            self.heading_label.setText('<h2>' + _("Checking for updates...") + '</h2>')
            self.detail_label.setText(_("Please wait while Pywallet checks for available updates."))
