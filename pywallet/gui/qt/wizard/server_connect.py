...
from pywallet.wizard import ServerConnectWizard
from pywallet.gui.qt.network_dialog import ProxyWidget, ServerWidget
from pywallet.gui.qt.util import icon_path
...
class QEServerConnectWizard(ServerConnectWizard, QEAbstractWizard):
    ...
    def __init__(self, config: 'SimpleConfig', app: 'QPywalletApplication', plugins: 'Plugins', daemon: 'Daemon', parent=None):
...
class WCWelcome(WizardComponent):
    def __init__(self, parent, wizard):
        ...
        self.wizard_title = _('Pywallet Bitcoin Wallet')
        ...
        pixmap = QPixmap(icon_path('pywallet_darkblue_1.png'))
        self.img_label.setPixmap(pixmap)
        self.img_label2 = QLabel()
        pixmap = QPixmap(icon_path('pywallet_text.png'))
