...
from pywallet.transaction import PartialTxOutput, PartialTransaction
from pywallet.lnutil import MIN_FUNDING_SAT
from pywallet.lnworker import hardcoded_trampoline_nodes
...
class NewChannelDialog(WindowModalDialog):
    ...
    def __init__(self, window: 'PywalletWindow', amount_sat: Optional[int] = None, min_amount_sat: Optional[int] = None):
