...
from pywallet.util import EventListener, ShortID
from pywallet.i18n import _
from pywallet.util import format_time
from pywallet.lnutil import format_short_channel_id, LOCAL, REMOTE, UpdateAddHtlc, Direction
from pywallet.lnchannel import htlcsum, Channel, AbstractChannel, HTLCWithStatus
from pywallet.lnaddr import LnAddr, lndecode
...
class ChannelDetailsDialog(QtWidgets.QDialog, MessageBoxMixin, QtEventListener):
    ...
    def __init__(self, window: 'PywalletWindow', chan: AbstractChannel):
