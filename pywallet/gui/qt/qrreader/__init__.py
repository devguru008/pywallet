# Copyright (C) 2021 The Pywallet developers
...
from pywallet.qrreader import get_qr_reader, QrCodeResult, MissingQrDetectionLib

from pywallet.gui.qt.util import MessageBoxMixin, custom_message_box
...
def find_system_cameras() -> Mapping[str, str]:
    ...
    if sys.platform == 'darwin' or sys.platform in ('windows', 'win32'):
        ...
        from pywallet import qrscanner
