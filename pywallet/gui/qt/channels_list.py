...
from pywallet.lnchannel import AbstractChannel, PeerState, ChannelBackup, Channel, ChannelState, ChanCloseOption
from pywallet.wallet import Abstract_Wallet
from pywallet.lnutil import LOCAL, REMOTE, format_short_channel_id
...
class ChannelsList(MyTreeView):
    ...
    def __init__(self, main_window: 'PywalletWindow'):
        super().__init__(
    ...
    def export_channel_backup(self, channel_id):
        msg = ' '.join([
            ...
            _("In the Pywallet mobile app, use the 'Send' button to scan this QR code."),
            '\n\n',
