...
from pywallet.util import InvoiceError
from pywallet.invoices import pr_expiration_values
...
class ReceiveTab(QWidget, MessageBoxMixin, Logger):
    ...
    def expiry_dialog(self):
        msg = ''.join([
            ...
            _('The bitcoin address never expires and will always be part of this pywallet wallet.'), ' ',
