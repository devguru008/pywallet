...
from pywallet import WalletStorage, Wallet
from pywallet.wallet import Abstract_Wallet
from pywallet.wallet_db import WalletDB
from pywallet.util import format_satoshis, EventListener, event_listener
from pywallet.bitcoin import is_address, COIN
from pywallet.transaction import PartialTxOutput
from pywallet.network import TxBroadcastError, BestEffortRequestFailed
...
class PywalletGui(BasePywalletGui, EventListener):
    ...
    def network_dialog(self):
        print("use 'pywallet setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'pywallet setconfig' to change your settings")
        return True
