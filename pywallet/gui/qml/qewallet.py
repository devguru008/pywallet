...
from pywallet.invoices import InvoiceError, PR_PAID, PR_BROADCASTING, PR_BROADCAST
from pywallet.logging import get_logger
from pywallet.network import TxBroadcastError, BestEffortRequestFailed
from pywallet.transaction import PartialTransaction, Transaction
from pywallet.util import InvalidPassword, event_listener, AddTransactionException, get_asyncio_loop
from pywallet.plugin import run_hook
from pywallet.wallet import Multisig_Wallet
from pywallet.crypto import pw_decode_with_version_and_mac
...
class QEWallet(AuthMixin, QObject, QtEventListener):
    ...
    # so we have only one QEWallet for each pywallet.wallet
    @classmethod
