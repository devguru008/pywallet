...
from pywallet.util import profiler
...
from .qeapp import PywalletQmlApplication, Exception_Hook


class PywalletTranslator(QTranslator):
...
class PywalletGui(BasePywalletGui, Logger):
    ...
    def __init__(self, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        self.app = PywalletQmlApplication(sys.argv, config=config, daemon=daemon, plugins=plugins)
        self.translator = PywalletTranslator()
        ...
        self.app.engine.load('pywallet/gui/qml/components/main.qml')
