...
from pywallet.util import send_exception_to_crash_reporter, UserFacingException
...
class QEQRScanner(QObject):
    ...
    def open(self):
        if 'ANDROID_DATA' not in os.environ:
            ...
            return
        jSimpleScannerActivity = autoclass("co.caprifin.qr.SimpleScannerActivity")
    ...
    def _scan_qr_non_android(self):
        ...
        # from .qeapp import PywalletQmlApplication
        # daemon = PywalletQmlApplication._daemon
