...
from pywallet.crypto import aes_encrypt_with_iv, aes_decrypt_with_iv
from pywallet.i18n import _
from pywallet.util import log_exceptions, ignore_exceptions, make_aiohttp_session
...
class LabelsPlugin(BasePlugin):
    ...
    def __init__(self, parent, config, name):
        ...
        self.target_host = 'labels.pywallet.org'
        self.wallets = {}
