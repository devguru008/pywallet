...
from pywallet.keystore import ScriptTypeNotSupported

from pywallet.plugins.hw_wallet.qt import QtHandlerBase, QtPluginBase
from pywallet.plugins.hw_wallet.plugin import only_hook_if_libraries_available, OutdatedHwFirmwareException

from pywallet.gui.qt.util import (WindowModalDialog, WWLabel, Buttons, CancelButton,
                                  OkButton, CloseButton, PasswordLineEdit, getOpenFileName, ChoiceWidget)
from pywallet.gui.qt.wizard.wallet import WCScriptAndDerivation, WCHWUnlock, WCHWXPub, WalletWizardComponent
...
PASSPHRASE_HELP = PASSPHRASE_HELP_SHORT + "  " + _(
    "You need to create a separate Pywallet for each passphrase "
