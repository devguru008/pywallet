# ----------------------------------------------------------------------------------
# Pywallet plugin for the Digital Bitbox hardware wallet by Shift Devices AG
# digitalbitbox.com
#
...
from pywallet.crypto import sha256d, EncodeAES_bytes, DecodeAES_bytes, hmac_oneshot
from pywallet.bitcoin import public_key_to_p2pkh, usermessage_magic
from pywallet.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, is_all_public_derivation
from pywallet.bip32 import normalize_bip32_derivation
...
from pywallet.util import to_string, UserCancelled, UserFacingException, bfh
from pywallet.network import Network
from pywallet.logging import get_logger
from pywallet.plugin import runs_in_hwd_thread, run_in_hwd_thread
...
class DigitalBitbox_Client(HardwareClientBase):
    ...
    def check_device_dialog(self):
        ...
        if not self.setupRunning:
            self.isInitialized = True # Wallet exists. Pywallet code later checks if the device matches the wallet
    ...
    def dbb_generate_wallet(self):
        ...
        filename = ("Pywallet-" + time.strftime("%Y-%m-%d-%H-%M-%S") + ".pdf")
    ...
    def sign_transaction(self, tx, password):
        ...
        try:
            ...
            for i, txin in enumerate(tx.inputs()):
                ...
                assert desc
                if desc.to_legacy_pywallet_script_type() != 'p2pkh':
