...
from pywallet.util import UserCancelled
from pywallet.keystore import bip39_normalize_passphrase
from pywallet.bip32 import BIP32Node, convert_bip32_strpath_to_intpath
from pywallet.logging import Logger
from pywallet.plugin import runs_in_hwd_thread
from pywallet.plugins.hw_wallet.plugin import HardwareClientBase, HardwareHandlerBase
...
class KeepKeyClientBase(HardwareClientBase, GuiMixin, Logger):
    ...
    def has_usable_connection_with_device(self):
        try:
            res = self.ping("pywallet pinging device")
            assert res == "pywallet pinging device"
