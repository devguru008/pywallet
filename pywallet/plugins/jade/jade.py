...
from pywallet.transaction import Transaction
from pywallet.wallet import Multisig_Wallet
from pywallet.util import UserFacingException
from pywallet.logging import get_logger
from pywallet.plugin import runs_in_hwd_thread, Device
from pywallet.network import Network

from pywallet.plugins.hw_wallet import HW_PluginBase, HardwareClientBase
from pywallet.plugins.hw_wallet.plugin import OutdatedHwFirmwareException
...
def _register_multisig_wallet(wallet, keystore, address):
    ...
    # NOTE: pywallet multisigs appear to always be sorted-multisig
            ...
            for index, txout in enumerate(tx.outputs()):
                if txout.is_mine and txout.is_change:
                    ...
                    if is_multisig:
                        ...
                        change[index] = {'path':path, 'variant': desc.to_legacy_pywallet_script_type()}
