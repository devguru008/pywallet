...
# Pywallet file password. As it is pure-python and runs in the CPU,
...
# Storage-encryption was introduced in Pywallet 2.8, keystore-encryption predates that.
# Newly created wallets in modern Pywallet have storage-encryption enabled by default.
#
...
from pywallet.util import InvalidPassword
