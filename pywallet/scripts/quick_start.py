...
from pywallet.wallet import Wallet, create_new_wallet
from pywallet.wallet_db import WalletDB
from pywallet.commands import Commands
from pywallet.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.pywallet/testnet as datadir
