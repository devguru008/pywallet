...
class LnFeatures(IntFlag):
    ...
    OPTION_TRAMPOLINE_ROUTING_REQ_PYWALLET = 1 << 150
    OPTION_TRAMPOLINE_ROUTING_OPT_PYWALLET = 1 << 151

    _ln_feature_contexts[OPTION_TRAMPOLINE_ROUTING_REQ_PYWALLET] = (LNFC.INIT | LNFC.NODE_ANN | LNFC.INVOICE)
    _ln_feature_contexts[OPTION_TRAMPOLINE_ROUTING_OPT_PYWALLET] = (LNFC.INIT | LNFC.NODE_ANN | LNFC.INVOICE)
...
LN_FEATURES_IMPLEMENTED = (
        ...
        | LnFeatures.OPTION_TRAMPOLINE_ROUTING_OPT_PYWALLET | LnFeatures.OPTION_TRAMPOLINE_ROUTING_REQ_PYWALLET
